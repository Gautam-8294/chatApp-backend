...
app.use(cors({
    ...
    origin: ["https://chat-app-frontend-swart.vercel.app","https://chat-app-frontend-git-main-gautam-8294.vercel.app/","https://vercel.com/gautam-8294/chat-app-frontend/ECoynJ3SER2zB5e5rLmM5oijojeb"],
    methods: ["GET","POST"],
    credentials: true
}));
